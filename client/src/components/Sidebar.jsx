...
const Sidebar = ({sidebar,setSidebar}) => {
  ...
  return (
    ...
    flex-col items-center justify-between max-sm:absolute 
    top-14 bottom-0 ${sidebar ? 'transition-x-0' :
    'max-sm:-translate-x-full'} transition-all duration-300 ease-in-out`}>
        ...
        <div className='w-full p-4 px-7 border-t border-gray-200 flex 
        items-center justify-between'>
            <div onClick={openUserProfile} className='flex gap-2 items-center cursor-pointer'>
                ...
                <div>
                    ...
                    <p className='text-xs text-gray-500'>
                        <Protect plan='elite' fallback='Free'>
                            Elite
                        </Protect>
                        Plan
                    </p>
            ...
            <LogOut onClick={signOut} className='w-5 h-5 text-gray-400
