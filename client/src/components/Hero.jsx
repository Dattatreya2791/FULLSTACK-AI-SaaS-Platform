    ...
    bg-cover bg-no-repeat min-h-screen'>
        ...
        <div className='text-center mb-5'>
            ...
            font-semibold mx-auto leading-[1.2]'>
                Let's create amazing contents<br/>
                 <span className='text-primary'>with AI tools</span>
            </h1>
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl
            m-auto max-sm:text-xs text-gray-600'>Transform your content creation with out suite of premium AI tools.
                Write Articles, Generate Images, Remove Objects, Review Resumes and more.
            </p>
        </div>

        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            <button onClick={()=> navigate('/ai')} className='bg-primary text-white px-10 py-3 rounded-lg
            border border-gray-300 hover:scale-105 transition cursor-pointer'>Let's Making now</button>
            <button className='bg-white px-10 py-3 rounded-lg border border-gray-300
            hover:scale-105 active:scale-95 transition cursor-pointer'><b>Watch demo</b></button>
        </div>

        <div className='flex flex-wrap items-center justify-center gap-3 mt-7 mx-auto text-gray-600'>
