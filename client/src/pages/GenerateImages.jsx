...
const GenerateImages = () => {
  ...
  const imageStyle = ['Realistic', 'Cartoon', 'Ghibli', 'Anime', 'Fantasy', '3D', 'Portrait'];
  ...
  return (
    ...
    flex-wrap gap-4 text-slate-700'>
      ...
      border border-gray-200'>
        ...
        placeholder='Describe what you want to see in this image..' required/>
        ...
        <div className='mt-3 flex gap-3 flex-wrap sm:max-w-19/11'>
          ...
          <div className='my-6 flex items-center gap-2'>
            <label className='relative cursor-pointer'>
              <input type="checkbox" name="publish" id="" onChange={(e)=> setPublish(e.target.checked)} 
